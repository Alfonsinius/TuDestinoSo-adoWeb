...
<html>
    ...
    <body style="background-color:#273746;">
        ...
        <div class="container">
            <form action="../Data/RutaUnoAlgoritmoEuclidesUbicacionReferencia.php" method="post" > 
                <center>
                ...
                <select name="selectGeneralLocation" id="framework" class="form-control selectpicker">   
            ...
            <select name="selectSpecificLocation" id="framework" class="form-control selectpicker">   

                <option value="1">Básilica de los Angeles</option>
                <option value="2">Ruinas de Cartago</option>                 
                <option value="3">Iglesia Maria Auxiliadora</option>
